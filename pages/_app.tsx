  ...
  return (
    <ThemeProvider theme={THEMES.BASE}>
      <Head>
        ...
        <meta
          name="description"
          content="El mejor lugar para tomarte un descanso en el Valle de Calamuchita. Bienvenido a la tranquilidad de las Sierras de Córdoba."
        />
        <meta
          property="og:title"
        ...
        <meta property="og:image" content="%PUBLIC_URL%/images/hero.jpg" />
